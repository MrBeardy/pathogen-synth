...
export default class Knob extends React.Component {
  ...
  //
  // componentDidMount() {
  //   this.refs.svg.addEventListener("load", this.handleSVGLoad)
  // }
  //
  // handleSVGLoad(ev) {
  //   let svg = ev.target.contentDocument.querySelector("svg");
  //   let title = svg.getElementById("props-title");
  //
  ...
  render() {
    ...
    return (
      <object ref="svg" data="svg/Knob.svg?title=hello world" type="image/svg+xml">
      </object>
    )
  }
}
...
//     let theme;
//
//     if (Knob.Themes.hasOwnProperty(this.props.theme)) {
//       theme = this.props.theme;
//     } else {
//       theme = "Default";
//     }
//
//     return Knob.Themes[theme].render(this, this.props, this.state);
//
//     let Components = {};
//
